...
class ContrarianStrategy(StrategyBaseModel):
    def decide(self, agent:AgentBaseModel, gpu_price: float, turn: int) -> Dict[str, bool]:
        ...
        The decision is made based on the change in GPU price from the previous turn:
        - If the price has decreased by 1% or more, the agent has a 75% chance of buying and a 25% chance of doing nothing.
        - Otherwise, the agent has a 20% chance of selling and an 80% chance of doing nothing.
